												...
												<!--/candile-->
													<div class="candile"> 
															...
															vis.render();
																	...
																	<script type="text/javascript" src="{{ asset('/') }}admin/js/protovis-d3.2.js"></script>
																	<script type="text/javascript" src="{{ asset('/') }}admin/js/vix.js"></script>
												    ...
												    <div class="chrt-bars">
														<div class="col-md-6 chrt-two">
														 <h3 class="sub-tittle">Bar Chart </h3>
															<div id="chart2"></div>
															<script src="{{ asset('/') }}admin/js/fabochart.js"></script>
															<script>
