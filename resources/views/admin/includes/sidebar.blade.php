<div class="sidebar-menu">
			...
			<!--/down-->
							<div class="down">	
									...
									<ul>
									<li><a class="tooltips" href="index.html"><span>Logout</span><i class="lnr lnr-user"></i></a></li>
                           ...
                           <div class="menu">
									<ul id="menu" >
									    <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Category Info</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="{{ route('add-category') }}">Add Category</a></li>
											<li id="menu-academico-boletim" ><a href="{{ route('manage-category') }}">Manage Category</a></li>
											
										  </ul>
										</li>
										<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Subcategory Info</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="{{ route('add-subcategory') }}">Add Subcategory</a></li>
											<li id="menu-academico-boletim" ><a href="{{ route('manage-subcategory') }}">Manage Subategory</a></li>
											
										  </ul>
										</li>
										<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Brand Info</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="{{ route('add-brand') }}">Add Brand</a></li>
											<li id="menu-academico-boletim" ><a href="{{ route('manage-brand') }}">Manage Brand</a></li>
											
										  </ul>
										</li>
										
										<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Product Info</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub">
											<li id="menu-academico-avaliacoes" ><a href="{{ route('add-product') }}">Add Product</a></li>
											<li id="menu-academico-boletim" ><a href="{{ route('manage-product') }}">Manage Product</a></li>
											
										  </ul>
										</li>
										<li id="menu-academico" ><a href="{{ route('income.create') }}"><i class="fa fa-table"></i> <span>Income</span> <span class="fa fa-angle-right" style="float: right"></span></a>
