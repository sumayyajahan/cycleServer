         ...
         <div class="bike-parts-sec">
              <div class="bike-parts">
                 ...
                 <div class="bike-apparels">
                     <div class="parts1">
                         <a href="{{ route('single') }}"><div class="part-sec">                    
                             <img src="{{ asset('/') }}assets/images/p1.jpg" alt=""/>
                             <div class="part-info">
                                 <a href="#"><h5>Wire Locks<span>$7.00</span></h5></a>
                                 <a class="add-cart" href="{{ route('single') }}">Quick View</a>
                                 <a class="qck" href="{{ route('single') }}">BUY NOW</a>
                             </div>
                         </div></a>
                         <a href="{{ route('single') }}"><div class="part-sec">                    
                         ...
                         <a href="{{ route('single') }}"><div class="part-sec none1">                  
                     ...
                     <div class="parts4">
                         <a href="{{ route('single') }}"><div class="part-sec bottom-line">                    
                         ...
                         <a href="{{ route('single') }}"><div class="part-sec bottom-line none1">                  
